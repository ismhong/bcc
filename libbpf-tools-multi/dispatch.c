...
extern int argdist_main(int argc, char **argv);
extern int bashreadline_main(int argc, char **argv);
extern int bindsnoop_main(int argc, char **argv);
extern int biolatency_main(int argc, char **argv);
extern int biopattern_main(int argc, char **argv);
extern int biosnoop_main(int argc, char **argv);
extern int biostacks_main(int argc, char **argv);
extern int biotop_main(int argc, char **argv);
extern int bitesize_main(int argc, char **argv);
extern int cachestat_main(int argc, char **argv);
extern int capable_main(int argc, char **argv);
extern int cmasnoop_main(int argc, char **argv);
extern int cmatop_main(int argc, char **argv);
extern int cmatrack_main(int argc, char **argv);
extern int cpudist_main(int argc, char **argv);
extern int cpufreq_main(int argc, char **argv);
extern int cpuidle_main(int argc, char **argv);
extern int cputop_main(int argc, char **argv);
extern int drsnoop_main(int argc, char **argv);
extern int execsnoop_main(int argc, char **argv);
extern int exitsnoop_main(int argc, char **argv);
extern int filelife_main(int argc, char **argv);
extern int filetop_main(int argc, char **argv);
extern int forksnoop_main(int argc, char **argv);
extern int fsdist_main(int argc, char **argv);
extern int fsslower_main(int argc, char **argv);
extern int funclatency_main(int argc, char **argv);
extern int funcslower_main(int argc, char **argv);
extern int futexctn_main(int argc, char **argv);
extern int gethostlatency_main(int argc, char **argv);
extern int gpumemtop_main(int argc, char **argv);
extern int hardirqs_main(int argc, char **argv);
extern int javagc_main(int argc, char **argv);
extern int klockstat_main(int argc, char **argv);
extern int ksnoop_main(int argc, char **argv);
extern int linuxfiletop_main(int argc, char **argv);
extern int llcstat_main(int argc, char **argv);
extern int loadavg_main(int argc, char **argv);
extern int mdflush_main(int argc, char **argv);
extern int memleak_main(int argc, char **argv);
extern int memleaktop_main(int argc, char **argv);
extern int mmclatency_main(int argc, char **argv);
extern int mmctop_main(int argc, char **argv);
extern int mountsnoop_main(int argc, char **argv);
extern int netaggr_main(int argc, char **argv);
extern int numamove_main(int argc, char **argv);
extern int offcputime_main(int argc, char **argv);
extern int oomkill_main(int argc, char **argv);
extern int opensnoop_main(int argc, char **argv);
extern int pagealloctop_main(int argc, char **argv);
extern int pageowner_main(int argc, char **argv);
extern int poweralloc_main(int argc, char **argv);
extern int profile_main(int argc, char **argv);
extern int readahead_main(int argc, char **argv);
extern int rpcdist_main(int argc, char **argv);
extern int rpcsnoop_main(int argc, char **argv);
extern int rpctop_main(int argc, char **argv);
extern int rpcundone_main(int argc, char **argv);
extern int rtkheaptop_main(int argc, char **argv);
extern int runqlat_main(int argc, char **argv);
extern int runqlen_main(int argc, char **argv);
extern int runqslower_main(int argc, char **argv);
extern int schedblockedtop_main(int argc, char **argv);
extern int sigsnoop_main(int argc, char **argv);
extern int slabratetop_main(int argc, char **argv);
extern int smclatency_main(int argc, char **argv);
extern int smctop_main(int argc, char **argv);
extern int softirqs_main(int argc, char **argv);
extern int softirqslower_main(int argc, char **argv);
extern int solisten_main(int argc, char **argv);
extern int stackcount_main(int argc, char **argv);
extern int statsnoop_main(int argc, char **argv);
extern int syncsnoop_main(int argc, char **argv);
extern int syscount_main(int argc, char **argv);
extern int tcpconnect_main(int argc, char **argv);
extern int tcpconnlat_main(int argc, char **argv);
extern int tcplife_main(int argc, char **argv);
extern int tcppktlat_main(int argc, char **argv);
extern int tcprtt_main(int argc, char **argv);
extern int tcpstates_main(int argc, char **argv);
extern int tcpsynbl_main(int argc, char **argv);
extern int tcptop_main(int argc, char **argv);
extern int tcptracer_main(int argc, char **argv);
extern int tcpwin_main(int argc, char **argv);
extern int vfsstat_main(int argc, char **argv);
extern int vmallocleak_main(int argc, char **argv);
extern int vmoom_main(int argc, char **argv);
extern int wakeuptime_main(int argc, char **argv);
extern int whoentercritical_main(int argc, char **argv);
extern int whoentercriticalstack_main(int argc, char **argv);
extern int whoentersmc_main(int argc, char **argv);
