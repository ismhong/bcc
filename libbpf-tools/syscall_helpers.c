...
static const char *syscall_names_arm32[] = {
	[0] = "restart_syscall",
	[1] = "exit",
	[2] = "fork",
	[3] = "read",
...
size_t syscall_names_arm32_size = sizeof(syscall_names_arm32)/sizeof(char*);
#endif
...
#elif defined(__arm__)
	else if (n < syscall_names_arm32_size)
		name = syscall_names_arm32[n];
#endif
...
#elif defined(__arm__)
	if (!size) {
		size = syscall_names_arm32_size;
		list = syscall_names_arm32;
	}
#endif
